...
<body style="">
	...
	<?php
		...
		$sql = "select * from member where no=" . $_POST['member_exit_member_no'];
		...
		if($result)
		{
			...
			if($result->num_rows > 0)
			{
				...
				while($row = $result->fetch_assoc())
				{
					...
					if(password_verify($_POST['member_exit_password'], $password))
					{
						
						
						$conn = new mysqli("localhost", "root", "sdm9469", "math_overflow");

						$sql_exit = "delete from member where no=" . $_SESSION['user_member_no'];
						$result_exit = $conn->query($sql_exit);
						if(!$result_exit)
						{
							echo "<div style=\"width:50%;margin-top:100;margin:auto;margin-bottom:500\">";
							echo "<table width=100%><tr><td colspan=2 style=\"padding-bottom:50px\"><center><br><br><br><br><br><br><br><br><br><br><br>잘못된 접근입니다.<br><br></center></td></tr>";
							echo "<tr><td width=50%><button style=\"width:90%\" type=\"button\" class=\"snip1535_list\" onclick=\"location.href='/index.html'\">홈으로&nbsp;&nbsp;&nbsp;&nbsp;</button></td>
									<td width=50%><button style=\"width:90%\" type=\"button\" class=\"snip1535_list\" onclick=\"history.back();\">뒤로
									</button></td>
						...
						echo "<div style=\"width:50%;margin-top:100;margin:auto;margin-bottom:500\">";
						echo "<table width=100%><tr><td colspan=2 style=\"padding-bottom:50px\"><center><br><br><br><br><br><br><br><br><br><br><br>회원 탈퇴가 완료되었습니다.<br><br></center></td></tr>";
						echo "<tr><td width=100%><button style=\"width:100%\" type=\"button\" class=\"snip1535_list\" onclick=\"location.href='/index.html'\">홈으로</button></td>
					...
					else
					{
						echo "<br><br><br><br><br><br>";
						echo "<div style=\"width:50%;margin-top:100;margin:auto;margin-bottom:500\">";
						echo "<table width=100%><tr><td colspan=2 style=\"padding-bottom:50px\"><center><br><br><br><br><br><br><br><br><br><br><br>비밀번호를 잘못 입력하였습니다.<br><br></center></td></tr>";
						echo "<tr><td width=50%><button style=\"width:100%\" type=\"button\" class=\"snip1535_list\" onclick=\"location.href='/index.html'\">홈으로</button></td>
								<td width=50%><button style=\"width:100%\" type=\"button\" class=\"snip1535_list\" onclick=\"history.back();\">뒤로
								</button></td>
